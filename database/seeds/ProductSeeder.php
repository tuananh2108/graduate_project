    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                ...
                'category_id' => Category::where('name', 'Gạch bông porcelain')->first()->id,
            ],
            [
                'product_code' => 'LX6639',
            ...
            [
                ...
                'category_id' => Category::where([['name', '150x800mm'], ['parent', Category::where('name', 'Gạch gỗ thanh')->first()->id]])->first()->id,
            ],
            [
                'product_code' => 'LX8825',
            ...
            [
                ...
                'category_id' => Category::where([['name', '600x600mm'], ['parent', Category::where('name', 'Gạch lát nền')->first()->id]])->first()->id,
            ],
            [
                'product_code' => 'VN3302',
                ...
                'category_id' => Category::where([['name', '300x300mm'], ['parent', Category::where('name', 'Gạch lát nền')->first()->id]])->first()->id,
            ],
        ]);
    }
}
