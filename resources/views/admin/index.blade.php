        ...
        <div class="panel panel-blue panel-widget ">
          <div class="row no-padding">
            ...
            <div class="col-sm-9 col-lg-8 widget-right">
              <div class="large">{{ number_format(reset($revenue), 0, '', '.') }}đ</div>
              <div class="text-muted">Doanh thu tháng {{ key($revenue) }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="panel panel-orange panel-widget">
          <div class="row no-padding">
            ...
            <div class="col-sm-9 col-lg-7 widget-right">
              <div class="large">{{ number_format($orders, 0, '', '.') }}</div>
      ...
      <div class="col-xs-12 col-md-6 col-lg-3">
        <div class="panel panel-teal panel-widget">
          <div class="row no-padding">
            ...
            <div class="col-sm-9 col-lg-7 widget-right">
              <div class="large">{{ number_format($delivered_orders, 0, '', '.') }}</div>
              <div class="text-muted">Số đơn hàng đã giao</div>
            </div>
          </div>
        </div>
      </div>
