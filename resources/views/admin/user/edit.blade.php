    ...
    <div class="box box-default">
        ...
        <div class="col-md-12">
          @if (session('message'))
            <div class="alert bg-danger" role="alert">
              ...
              </svg>{{ session('message') }}<a href="{{ asset('admin/user/edit' . $user->id) }}" class="pull-right"><span
      ...
      <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input name="name" type="text" value="{{ $user->name }}" class="form-control"
                  placeholder="Vui lòng nhập họ tên nhân viên" required>
                @if ($errors->has('name'))
              ...
              <div class="form-group">
                ...
                <input name="email" type="email" value="{{ $user->email }}" class="form-control"
                  placeholder="Vui lòng nhập email đăng nhập" required>
                @if ($errors->has('email'))
              ...
              <div class="form-group">
                ...
                <input name="password" type="password" value="{{ $user->password }}"
                  class="form-control" placeholder="Vui lòng nhập mật khẩu đăng nhập" required>
              ...
              <div class="form-group">
                ...
                <input name="phone_number" type="text" value="{{ $user->phone_number }}"
                  class="form-control" placeholder="Nhập số điện thoại của nhân viên">
        ...
        <div class="box-footer">
          <a href=" {{ asset('admin/user') }}" class="btn btn-danger" style="margin-left: 15px; margin-bottom: 50px;">Hủy
            bỏ</a>
